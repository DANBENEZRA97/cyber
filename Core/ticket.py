...
class Ticket(AuditMixin, NotifiableMixin):  # הורשה מרובה (דרישה)
    def __init__(self, ticket_id: str, customer_id: str, service_id: str) -> None:
        ...
        self.log(f"Ticket created (customer={customer_id}, service={service_id})")
    ...
    def summary(self) -> str:
        ...
        return f"{self.ticket_id} | {self.status} | {t}"
